...
$tableName = $installer->getTable('evozon_firsttask/link');
...
if ($installer->getConnection()->isTableExists($tableName) != true) {
    $table = $installer->getConnection()
            ...
            $installer->getFkName(
                    'evozon_firsttask/link',
                    'banner_id',
                    'evozon_firsttask/banner',
                    'banner_id'
                ),
                'banner_id', $installer->getTable('evozon_firsttask/banner'), 'banner_id',
                Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE);
