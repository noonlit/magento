...
Mage::log('Started data-upgrade-0.1.5-0.1.6 (adding a bundle product)', null, 'scripts.log');
...
Mage::log('Ended data-upgrade-0.1.5-0.1.6 (adding a bundle product)', null, 'scripts.log');
Mage::log('==========================================================================', null, 'scripts.log');